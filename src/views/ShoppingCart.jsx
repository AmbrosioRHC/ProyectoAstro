...
function ShoppingCart() {
  ...
  const total = cart ? cart.reduce((acc, item) => acc + item.photo_price * item.quantity, 0) : 0;
      ...
      <div className="shopping-cart-container">
        <div className="cart-items-container">
                    ...
                    <div className="row no-gutters">
                      ...
                      <div className="col-md-8">
                        <div className="card-body text-dark">
                          ...
                          <p className="card-text">Precio: ${item.photo_price.toFixed(2)}</p>
          ...
          <div className="cart-summary">
            ...
            <Link to="/shopform" className="btn btn1 btn-primary d-block mx-auto">
              Ir a Pagar
            </Link>
          </div>
        </div>
