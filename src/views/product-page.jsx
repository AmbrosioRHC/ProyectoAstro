                ...
                <div className="row justify-content-around mt-5">
                    <div className="containerImage col-5 container">
                        ...
                        <div className="rating mt-3 ">
                            <span>rating {products.rating} <i className="fa-solid fa-star"></i></span>
                        </div>
                    </div>
                    <div className="rightContainer col-5 mt-5 container">
                        <div className="mt-3" >
                            <div className="row">
                                <div className="col-8">
                                    <p className="fs-4 fw-semibold"> {products.name}</p>
                                </div>
                                <div className="col-4">
                                    ...
                                    <p className="float-end m-2"><i className="fa-solid fa-heart"></i>{products.likes}</p>
                                </div>
                            </div>
                        </div>
                        <div className="row mt-3">
                            ...
                            <div className="reviews float-end col-3 mt-5"><p><i className="fa-regular fa-comment-dots"></i> {products.reviews} reviews</p></div>
                        </div>
                        <div className=" mt-5">
                        ...
                        <div className="mt-5">
                            <button onClick={() => removeFromCart(products.id)} className="btn btn-danger rounded-pill"><i className="fa-solid fa-trash"></i>  Eliminar del carrito</button>
                        </div>
                        <div>
                        {cart.length > 0 ? (
    <div>
