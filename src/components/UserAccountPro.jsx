...
//           <div className={styles.thumbnailContainer}>
//             {thumbnails.slice(0, 24).map((thumbnail, index) => (
//               <div key={index} className={styles.thumbnail} onClick={() => handleThumbnailClick(thumbnail)}>
...
//       {fullscreenImage && (
//         <div className={styles.fullscreen} onClick={closeFullscreen}>
//           <button className={styles.fullscreenClose} onClick={closeFullscreen}>X</button>
//           <img src={fullscreenImage} alt="Fullscreen" />
//         </div>
//       )}
//     </div>
